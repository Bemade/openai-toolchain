...
class OpenAIClient:
    ...
    def chat(
        ...
        tools: Optional[List[Union[Dict, str]]] = None,
        ...
        **kwargs
        ...
        if tools is None:
            ...
            # If tools are provided as strings, filter the registered tools
            if tools and isinstance(tools[0], str):
                ...
                tool_schemas = tools  # Use provided tool definitions as-is
    ...
    def _convert_message(self, message: Dict[str, Any]) -> ChatCompletionMessageParam:
